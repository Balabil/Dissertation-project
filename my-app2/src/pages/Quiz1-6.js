...
function Card(props){
    ...
    const [isCorrect,setIsCorrect] = useState('operating');
    ...
    async function increaseExp() {
        ...
        const response = await fetch('http://localhost:1337/api/quiz2', {
          method: 'POST',
          headers: {
            'Content-Type': 'application/json',
            'x-access-token':  localStorage.getItem('token'),
    ...
    return (
        ...
        <div className="card2">
            <div className="card__body">
                ...
                <p className="card__description">At this step click on the link for the Raspberry Pi Imager that matches your _______ system</p> 
