    ...
    return (
        ...
        <div className="card2">
            <div className="card__body">
                ...
                <p className="card__description">What is the colour of the LED to indicate the Raspberry Pi is connected to power?</p> 
                <button onClick={check} className={`card_btn2 ${isCheck ? 'card_btn2-checked' : ''}`}>Red</button> 
                <button onClick={onClick2} className={`card_btn2 ${isCheck2 ? 'card_btn2-checked' : ''}`}>Green</button> 
                <button onClick={onClick3} className={`card_btn2 ${isCheck3 ? 'card_btn2-checked' : ''}`}>Blue</button>
