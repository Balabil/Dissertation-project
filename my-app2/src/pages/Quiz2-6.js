...
function Card(props){
    ...
    const [isCorrect,setIsCorrect] = useState('raspberries');
    ...
    return (
        ...
        <div className="card2">
            <div className="card__body">
                <h2 className="card__title">QUESTION 7</h2>
                <h2 className="card__title2">Please fill in the blank.</h2>
                <p className="card__description">You should see a red LED light up on the Raspberry Pi, which indicates that Raspberry Pi is connected to power. As it starts up (this is also called booting), you will see _______ appear in the top left-hand corner of your screen.</p> 
