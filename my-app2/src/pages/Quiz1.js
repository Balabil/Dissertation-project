    ...
    return (
        ...
        <div className="card2">
            <div className="card__body">
                ...
                <p className="card__description">What is a Raspberry Pi?</p> 
                <button onClick={check} className={`card_btn2 ${isCheck ? 'card_btn2-checked' : ''}`}>Small Computer</button> 
                <button onClick={onClick2} className={`card_btn2 ${isCheck2 ? 'card_btn2-checked' : ''}`}>Small Phone</button> 
                <button onClick={onClick3} className={`card_btn2 ${isCheck3 ? 'card_btn2-checked' : ''}`}>Large Computer</button>
            ...
            <Popup open={open} closeOnDocumentClick onClose={closeModal}>        
              <div className="modal">          
                ...
                <a className="content">Achievement Unlocked! Answered First Question Correctly.</a>
              </div>      
              </Popup>
        </div>
    )
