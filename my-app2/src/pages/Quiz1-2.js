...
function Card(props){
    ...
    const [isCorrect,setIsCorrect] = useState('smaller');
    ...
    return (
        ...
        <div className="card2">
            <div className="card__body">
                <h2 className="card__title">QUESTION 3</h2>
                <h2 className="card__title2">Please fill in the blank.</h2>
                <p className="card__description">Raspberry Pi Zero, Raspberry Pi Zero W, and Raspberry Pi Zero WH are _______ and require less power, so they’re useful for portable projects such as robots.</p> 
