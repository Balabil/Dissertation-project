    ...
    return (
        ...
        <div className="card2">
            <div className="card__body">
                <h2 className="card__title">QUESTION 6</h2>
                <p className="card__description">What is the easiest way to install Raspberry Pi OS on your SD Card?</p> 
                <button onClick={check} className={`card_btn2 ${isCheck ? 'card_btn2-checked' : ''}`}>Raspberry Pi Imager</button> 
                <button onClick={onClick2} className={`card_btn2 ${isCheck2 ? 'card_btn2-checked' : ''}`}>Raspberry Pi Installer</button> 
                <button onClick={onClick3} className={`card_btn2 ${isCheck3 ? 'card_btn2-checked' : ''}`}>Raspberry Pi OS</button>
