    ...
    return (
        ...
        <div className="card2">
            <div className="card__body">
                ...
                <p className="card__description">How can you connect to the internet on the Raspberry Pi 4?</p> 
                <button onClick={onClick3} className={`card_btn2 ${isCheck3 ? 'card_btn2-checked' : ''}`}>Ethernet Only</button> 
                <button onClick={onClick2} className={`card_btn2 ${isCheck2 ? 'card_btn2-checked' : ''}`}>Wifi Only</button> 
                <button onClick={check} className={`card_btn2 ${isCheck ? 'card_btn2-checked' : ''}`}>Ethernet/Wifi</button>
