...
function Card(props){
    ...
    const [isCorrect,setIsCorrect] = useState('HDMI0');
    ...
    return (
        ...
        <div className="card2">
            <div className="card__body">
                ...
                <p className="card__description">Connect your screen to the first of Raspberry Pi 4’s HDMI ports, labelled ____.</p> 
