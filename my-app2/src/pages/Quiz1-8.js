...
function Card(props){
    ...
    const [isCorrect,setIsCorrect] = useState('overwritten');
    ...
    return (
        ...
        <div className="card2">
            <div className="card__body">
                ...
                <p className="card__description">Anything that’s stored on the SD card will be _______ during formatting.</p> 
