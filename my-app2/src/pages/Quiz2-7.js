    ...
    return (
        ...
        <div className="card2">
            <div className="card__body">
                <h2 className="card__title">QUESTION 8</h2>
                <p className="card__description">Which application pops up when you start up your raspberry pi for the first time?</p> 
                <button onClick={check} className={`card_btn2 ${isCheck ? 'card_btn2-checked' : ''}`}>Welcome to Raspberry Pi</button> 
                <button onClick={onClick2} className={`card_btn2 ${isCheck2 ? 'card_btn2-checked' : ''}`}>Raspberry Pi Installer</button> 
                <button onClick={onClick3} className={`card_btn2 ${isCheck3 ? 'card_btn2-checked' : ''}`}>Raspberry Pi Setup</button>
