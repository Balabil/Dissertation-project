    ...
    return (
        ...
        <div className="card2">
            <div className="card__body">
                <h2 className="card__title">QUESTION 9</h2>
                <p className="card__description">Which screen will you not see if your Raspberry Pi does not have wireless connectivity?</p> 
                <button onClick={onClick2} className={`card_btn2 ${isCheck2 ? 'card_btn2-checked' : ''}`}>Set Country</button> 
                <button onClick={check} className={`card_btn2 ${isCheck ? 'card_btn2-checked' : ''}`}>Select Wifi Network</button> 
                <button onClick={onClick3} className={`card_btn2 ${isCheck3 ? 'card_btn2-checked' : ''}`}>Select Ethernet</button>
