    ...
    return (
        ...
        <div className="card2">
            <div className="card__body">
                ...
                <p className="card__description">What RAM does the Raspberry Pi 4 come with?</p> 
                <button onClick={onClick2} className={`card_btn2 ${isCheck2 ? 'card_btn2-checked' : ''}`}>3GB</button> 
                <button onClick={check} className={`card_btn2 ${isCheck ? 'card_btn2-checked' : ''}`}>4GB</button> 
                <button onClick={onClick3} className={`card_btn2 ${isCheck3 ? 'card_btn2-checked' : ''}`}>12GB</button>
                <p className={`check ${isDisplay ? 'check-active' : ''}`}>Incorrect: +0xp</p>
                <p className={`check2 ${isDisplay2 ? 'check2-active' : ''}`}>Correct: +5xp</p>
            </div>
